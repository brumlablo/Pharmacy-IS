<?php
// source: /home/users/xh/xhamer02/WWW/IIS/app/config/config.neon 
// source: /home/users/xh/xhamer02/WWW/IIS/app/config/config.local.neon 

class Container_d46359889c extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/users/xh/xhamer02/WWW/IIS/app',
			'wwwDir' => '/home/users/xh/xhamer02/WWW/IIS/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/home/users/xh/xhamer02/WWW/IIS/app/../temp',
		));
	}
	...
	{
		$service = new App\Presenters\LekPresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/users/xh/xhamer02/WWW/IIS/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/users/xh/xhamer02/WWW/IIS/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:dbname=xhamer02;host=localhost;mysql_socket=/var/run/mysql/mysql.sock',
			'xhamer02', 'e8edurge', array('lazy' => TRUE));
	...
	{
		return new Container_d46359889c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/home/users/xh/xhamer02/WWW/IIS/app/../temp/cache/latte');
...
final class Container_d46359889c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_d46359889c $container)
	{
